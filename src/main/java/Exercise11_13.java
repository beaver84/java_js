...
class SutdaDeck
{
    ...
    SutdaCard11_13[] cards = new SutdaCard11_13[CARD_NUM];
    ...
    SutdaDeck() {
        for(int i=0;i < cards.length;i++) {
            ...
            cards[i] = new SutdaCard11_13(num,isKwang);
        }
    ...
    int getPoint(Player p) {
        if(p==null) return 0;
        SutdaCard11_13 c1 = p.c1;
        SutdaCard11_13 c2 = p.c2;
        Integer result = 0;
    ...
    SutdaCard11_13 pick() throws Exception {
        SutdaCard11_13 c = null;
...
class Player {
    ...
    SutdaCard11_13 c2;
    int point;
    Player(String name, SutdaCard11_13 c1, SutdaCard11_13 c2) {
        this.name = name ;
        this.c1 = c1 ;
        this.c2 = c2 ;
    }
...
class SutdaCard11_13 {
    int num;
    boolean isKwang;
    SutdaCard11_13() {
        this(1, true);
    }
    SutdaCard11_13(int num, boolean isKwang) {
        this.num = num;
